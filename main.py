...
def task_weather_dashboard():
    ...
    draw.text((245, 54), f"{weather['wind_info']}", font=font_small, fill=255)
    draw.text((245, 79), f"湿度 {weather['humidity']}", font=font_small, fill=255)
    draw.text((245, 104), f"体感 {weather['feel_temp']}", font=font_small, fill=255)
